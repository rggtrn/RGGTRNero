...
RGGTRN {
	...
	*turboCargar {
		...
		~luislacolegiala=Buffer.read(s, "~/samples/patioCSF.wav".standardizePath);
		~csf=Buffer.read(s, "~/samples/patioCSF.wav".standardizePath);
		~dembow=Buffer.read(s, "~/samples/dembow.wav".standardizePath);
		romantic=Buffer.read(s, "~/samples/romantic.wav".standardizePath);
		rggtrn2=Buffer.read(s, "~/samples/rggtrn2.wav".standardizePath);
		digital=Buffer.read(s, "~/samples/digital.wav".standardizePath);
		sonidero=Buffer.read(s, "~/samples/sonidero.wav".standardizePath);
		internacional=Buffer.read(s, "~/samples/internacional.wav".standardizePath);
		rggtrn=Buffer.read(s, "~/samples/rggtrn.wav".standardizePath);
		si=Buffer.read(s, "~/samples/si.wav".standardizePath);
		bombo=Buffer.read(s, "~/samples/bombo.wav".standardizePath);
		bajo=Buffer.read(s, "~/samples/bajo.wav".standardizePath);
		timbal=Buffer.read(s, "~/samples/timbal.wav".standardizePath);
		tom1=Buffer.read(s, "~/samples/tom1.wav".standardizePath);
		principio=Buffer.read(s, "~/samples/principio_2.wav".standardizePath);
		bote=Buffer.read(s, "~/samples/bote.wav".standardizePath);
		sabro=Buffer.read(s, "~/samples/sabro.wav".standardizePath);
		fuerte=Buffer.read(s, "~/samples/fuerte.wav".standardizePath);
		intro=Buffer.read(s, "~/samples/intro_soni.wav".standardizePath);
		congaC=Buffer.read(s, "~/samples/congaC.wav".standardizePath);
		congaS=Buffer.read(s, "~/samples/congaS.wav".standardizePath);
		bongoP=Buffer.read(s, "~/samples/bongo2.aiff".standardizePath);
		bongoC=Buffer.read(s, "~/samples/bongoC.wav".standardizePath);
		busArray = [0,4];
